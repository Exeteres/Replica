        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Mute = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatRoutes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChatRoutes_Chats_ChatId",
                        column: x => x.ChatId,
                        principalTable: "Chats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatRoutes_Routes_RouteId",
                        column: x => x.RouteId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatRoutes_ChatId",
                table: "ChatRoutes",
                column: "ChatId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatRoutes_RouteId",
                table: "ChatRoutes",
                column: "RouteId");
